    ...
    Route::group(['middleware' => ['auth', 'verified']], function () {
        ...
        Route::group(['middleware' => ['Email2FA']], function () {
            ...
            Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
                ...
                Route::post('monthly_deposits/bulk_remind', [MonthlyDepositController::class, 'bulk_remind'])->name('monthly_deposits.bulk_remind');
                Route::post('monthly_deposits/reminder_settings', [MonthlyDepositController::class, 'reminder_settings'])->name('monthly_deposits.reminder_settings');
                Route::get('monthly_deposits/search_reminder_members', [MonthlyDepositController::class, 'search_reminder_members'])->name('monthly_deposits.search_reminder_members');
