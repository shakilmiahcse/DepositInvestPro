...
class SavingsAccountController extends Controller {
    ...
    public function get_table_data() {
        ...
        return Datatables::eloquent($savingsaccounts)
            ...
            ->addColumn('action', function ($savingsaccount) {
                ...
                . '<a class="dropdown-item" href="' . route('savings_accounts.show', $savingsaccount['id']) . '" data-title="' . _lang('Update Account') . '"><i class="ti-eye"></i>  ' . _lang('View') . '</a>'
    ...
    public function store(Request $request) {
        ...
        $savingsaccount->monthly_deposit_amount = $accountType->monthly_deposit_amount ?? 0;
    ...
    public function update(Request $request, $id) {
        ...
        $savingsaccount->status             = $request->input('status');
        $savingsaccount->opening_balance    = $request->input('opening_balance');
        $savingsaccount->monthly_deposit_amount = optional(SavingsProduct::find($request->input('savings_product_id')))->monthly_deposit_amount ?? 0;
        $savingsaccount->description        = $request->input('description');
