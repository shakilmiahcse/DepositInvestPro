(function ($) {
  ...
  $(".file-uploader").after(
    "<input type='text' class='form-control filename' readOnly>" +
      "<button type='button' class='btn btn-primary file-upload-btn'>Browse</button>"
  );
  ...
  $(document).on("click", ".print", function (event) {
    event.preventDefault();
    document.title = $(this).data('title') ?? document.title;
  ...
  $(document).on("click", ".ajax-modal", function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (reload == false) {
          $("#main_modal .ajax-submit, #main_modal .ajax-submit").attr(
            "data-reload",
            false
          );
        }
